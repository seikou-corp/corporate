...
export default function Page() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      {/* Top gradient area */}
      <div
        className="w-full pb-[500px] sm:pb-[450px] md:pb-[400px] relative -mt-[1px] pt-12"
      ...
      <div className="relative -top-[530px] md:-top-[630px]">
        ...
        <Image
          ...
          className={`absolute w-screen -translate-y-1/2 transition-all duration-700 delay-800 ${
            isLoaded ? 'top-[0px] opacity-100 scale-100' : '-top-[30px] opacity-0 scale-150'
          }`}
        />

        {/* ABOUT US image */}
        <div className="absolute top-[50px] sm:top-[155px] md:top-[230px] lg:top-[255px] w-full z-50">
          <Image
        ...
        <div className="relative bg-gradient-to-b from-[rgba(255,255,255,0.5)] to-white mx-auto px-4 w-full">
          <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="relative w-[495px] h-[385px] m-auto">
          ...
          <div className="max-w-6xl mx-auto px-4 relative z-10">
            <div className="relative">
              ...
              <div className="text-right relative z-50">
                ...
                <p className="text-base leading-[2rem] mb-8">
                  ...
                  <br />
                  そして、結果的に業績向上にもつながると信じています。
                  <br />
                  新しい価値創造に時間を使えるようになる世界を目指します。
                </p>
              </div>
              <div className="absolute z-0 -left-[50px] lg:left-0 top-[40px] sm:-top-[30px]">
                <div className="">
                  <Image
                    ...
                    width={350}
                    height={350}
                    className={`w-[300px] xl:w-[450px] sm:w-[350px] mb-4 transition-all duration-700 ${
                      isLoaded ? 'opacity-100 scale-100' : 'opacity-0 scale-90'
                    }`}
                  />
                </div>
            ...
            {/* Bottom CTA Button */}
            <div className="text-center mt-[250px] sm:mt-12">
        ...
        {/* Content Section */}
        <div className="py-20">
          <div className="relative left-0 mb-[60px]">
            <Image
              src="/images/about/about-01_content.png"
              alt="CONTENT"
              width={1219}
              height={94}
              className={`w-[800px] transition-all duration-700 ${
                isLoaded ? 'opacity-100 scale-100' : 'opacity-0 scale-90'
              }`}
            />
          </div>
                ...
                <div className="md:col-span-3 p-12 border-r border-gray-100">
                  ...
                  <div className="flex gap-4 px-4">
                    <a
                      ...
                      className="p-2 bg-[#272859] text-white rounded-full hover:bg-[#1e1f47] transition-colors"
                    >
                      <svg
