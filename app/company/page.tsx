            ...
            <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-12">
              ...
              <div className="bg-white/30 md:bg-none backdrop-blur-lg leading-relaxed relative mt-[0px] md:mt-[150px] p-12 md:p-0 md:w-[80%] xl:w-[60%]">
                ...
                <p className="text-sm leading-[1.8rem] text-justify pb-[100px]">
                  ジュエリーミュージアムでは、ママさんスタッフを中心に、明るく和気あいあいとした職場環境を大切にしています。お客様に楽しんでいただける製品を作ることを常に意識し、チーム一丸となって日々努力を重ねています。その結果、私たちのネックレスチェーンは、楽天年間ランキングで5年連続1位を獲得するという実績を誇ります。私たちのネットショップはアルバイトを含めて10名の小さなチームですが、Rakuboの導入により業務の効率化を実現し、更なる成長を目指しています。今後もお客様に愛されるブランドとして、共に成長し続けたいと考えています。
                  {/* Name at bottom */}
